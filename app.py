...
def user_input(user_question):
    ...
    # ✅ Automatically handle missing FAISS index
...
#     vector_store=FAISS.from_texts(text_chunks,embedding=embeddings) ## save local data 
#     vector_store.save_local("faiss_index")
...
# def user_input(user_qustion):
#     embeddings=GoogleGenerativeAIEmbeddings(model="gemini-embedding-001")
    
#     new_db=FAISS.load_local("fiss_index",embeddings,allow_dangerous_deserialization=True)
#     docs=new_db.similarity_search(user_qustion) 

#     chain=get_conversational_chain()

#     response=chain(
#         {"input_documents":docs ,"question":user_qustion},
